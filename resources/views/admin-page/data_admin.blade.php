                ...
                @foreach ($dataAdmin as $row)
                  <tr>
                      ...
                      <td style=" text-align: center;">
                        <a href="/form-edit-admin/{{$row->nip}}" class="text-warning"><i class="fas fa-edit"></i></a>
                        &nbsp;
                        <a href="#" onclick="delete_data(`{{$row->nip}}`, `{{$row->name}}`)" class="text-danger"><i class="fas fa-trash-alt"></i></a>
                      </td>
                  </tr>
                @endforeach
              </tbody>
