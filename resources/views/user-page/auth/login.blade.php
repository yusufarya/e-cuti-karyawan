...
<html lang="en" data-bs-theme="auto">
    <head> 
        ...
        <meta name="description" content="E-CUTI Karyyawan, Tenaga Kerja Kabupaten Tangerang">
                ...
                <form class="mt-3" action="/login" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <small class="ms-1 my-color-secondary"><b> Karyawan </b></small>
                        </div>
                        <div class="col">
                            <h1 class="h1 mb-2 pt-2 fw-bold my-color-secondary float-end">E-CUTI</h1>
                            <small class="ms-1 my-color-primary float-end"><b> PT. Just Jait Indonesia </b></small>
                        </div>
                    </div>
