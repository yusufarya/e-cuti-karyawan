...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <meta name="description" content="E-CUTI Latihan Kerja Dinas, Tenaga Kerja Kabupaten Tangerang">
            ...
            <div class="col-lg-5 col-md-5 col-sm-5 pe-5">
                <section class="form-register">
                    ...
                    <form class="mt-5" action="/register" method="POST">
                        @csrf
                        <h1 class="h3 mb-3 fw-bold my-color-primary">Buat Akun Untuk Menjadi Karyawan</h1>
